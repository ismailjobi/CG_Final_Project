...
void sound()
{
    if(!night)
    {
        PlaySound("D:\\Background.wav", NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
    }
...
void rain_sound()
{
    ...
    PlaySound("D:\\Rain.wav", NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
...
void fire_sound()
{
    if(!rainday && night)
    {
        PlaySound("D:\\Fire.wav", NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
    }
...
void fire(float Tx = 0, float Ty = 0)
{
    ...
    glVertex2f(Tx + 70, Ty + 70 + 20 * sin(time));
    glVertex2f(Tx + 35 + 5 * sin(time), Ty + 0);
    glVertex2f(Tx + 105 - 5 * sin(time), Ty + 0);

    glVertex2f(Tx + 42 + 5 * sin(time), Ty + 52.5 - 10 * sin(time));
    glVertex2f(Tx + 7 + 5 * sin(time), Ty + 0);
    glVertex2f(Tx + 77 - 5 * sin(time), Ty + 0);

    glVertex2f(Tx + 112 - 5 * sin(time), Ty + 52.5 - 10 * sin(time));
    glVertex2f(Tx + 77 + 5 * sin(time), Ty + 0);
    glVertex2f(Tx + 147 - 5 * sin(time), Ty + 0);

    glColor3ub(240, 240, 0);
    glVertex2f(Tx + 43.75 + 2.5 * sin(time), Ty + 26.25 - 5 * sin(time));
    glVertex2f(Tx + 17.5 + 2.5 * sin(time), Ty + 0);
    glVertex2f(Tx + 52.5 - 2.5 * sin(time), Ty + 0);

    glVertex2f(Tx + 78.75 - 2.5 * sin(time),Ty + 26.25 - 5 * sin(time));
    glVertex2f(Tx + 52.5 + 2.5 * sin(time),Ty + 0);
    glVertex2f(Tx + 87.5 + 2.5 * sin(time),Ty + 0);

    glVertex2f(Tx + 113.75 - 2.5 * sin(time), Ty + 26.25 - 5 * sin(time));
    glVertex2f(Tx + 87.5 + 2.5 * sin(time),Ty + 0);
    glVertex2f(Tx + 122.5 - 2.5 * sin(time),Ty + 0);
...
void mountain()
{
    //Rear mountain
    glBegin(GL_POLYGON);
    if(!night)glColor3ub(120, 58, 4);      //16 133 16
    else glColor3ub(10,52,10);
    glVertex2f(387, 500);
    glVertex2f(387, 760);
    glVertex2f(348, 765);
    glVertex2f(320, 774);
    ...
    glBegin(GL_POLYGON);
    if(!night)glColor3ub(43, 189, 43);
    else glColor3ub(15,70,15);
    glVertex2f(11, 678);
    glVertex2f(19, 706);
    glVertex2f(54, 710);
    glVertex2f(80, 730);
...
void river_marks()
{
    //river marks
    glBegin(GL_POLYGON);
    if(!night)glColor3ub(137, 227, 240);
    else glColor3ub(21,31,31);
    glVertex2f(376, 388);
    glVertex2f(419, 388);
    glVertex2f(576, 389);
    glVertex2f(556, 387);
...
void information(void)
{
    ...
    renderBitmapString(830, 1000, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Scenery of a Mountain");
    renderBitmapString(825, 950, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Computer Graphics [C]");
    renderBitmapString(200, 900, 0.0, GLUT_BITMAP_TIMES_ROMAN_24, "Group Member :");
    glBegin(GL_LINES);
    glColor3f(0.0f, 0.0f, 0.0f);
    glVertex2f(200, 880);
    glVertex2f(1720, 880);
    glEnd();
    renderBitmapString(320, 840, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "ID");
    renderBitmapString(930, 840, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Name");
    renderBitmapString(1500, 840, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Contribution");

    renderBitmapString(250, 800, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "21-44747-1");
    renderBitmapString(830, 800, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Md Ismail Jobi Ullah");
    renderBitmapString(1560, 800, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "35");

    renderBitmapString(250, 750, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "21-44401-1");
    renderBitmapString(830, 750, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Israk Hossain Pantho");
    renderBitmapString(1560, 750, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "20");

    renderBitmapString(250, 700, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "21-44151-1");
    renderBitmapString(830, 700, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Sadikul Mobasshir");
    renderBitmapString(1560, 700, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "15");

    renderBitmapString(250, 650, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "21-44398-1");
    renderBitmapString(830, 650, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Khondokar Faisal Ibn Aziz");
    renderBitmapString(1560, 650, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "15");

    renderBitmapString(250, 600, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "21-44399-1");
    renderBitmapString(830, 600, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Fahim Rafman");
    renderBitmapString(1560, 600, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "15");
    ...
    renderBitmapString(870, 500, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Supervised by :");
    renderBitmapString(830, 450, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Mahfujur Rahman");
    renderBitmapString(830, 420, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Lecturer");
    renderBitmapString(830, 390, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Department of Computer Science");
    renderBitmapString(830, 360, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "Faculty of Science and Technology");
    renderBitmapString(830, 330, 0.0f, GLUT_BITMAP_TIMES_ROMAN_24, "American International University-Bangladesh(AIUB)");
...
{
    cout << "For go to Home Page : press 'H'" << endl;
    cout << "For Night Scene     : press 'N'" << endl;
    cout << "For Rain            : press 'R'" << endl;
    cout << "For Stop Rain       : press 'A'" << endl;
    cout << "For sunset          : press 'W'" << endl;
